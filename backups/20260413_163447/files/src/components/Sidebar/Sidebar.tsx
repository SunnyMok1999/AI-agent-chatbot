...
import { MessageSquare, Plus, Trash2, Edit3, Settings, LogOut, FileUp, BarChart3 } from 'lucide-react';
    ...
    <div className="flex flex-col h-full w-64 bg-slate-50 dark:bg-slate-950 border-r dark:border-slate-800 p-4 gap-4">
      ...
      <div className="border-t dark:border-slate-800 pt-4 space-y-2">
        <button
          ...
          className={cn(
            'flex items-center gap-2 rounded-lg p-2 text-sm transition-colors w-full',
